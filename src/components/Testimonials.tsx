...
const testimonials = [
  ...
  {
    content: "The insights we get from 's dashboard have helped us identify and cut unnecessary spending. We've reduced our SaaS expenses by 30% in just three months.",
    author: "Michael Chen",
    role: "CEO, GrowthLabs",
